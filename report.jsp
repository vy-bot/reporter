...
<%!
	...
	*/
    ...
    //Allow brows ing and file manipulation only in certain directories
...
Upload finished.
		...
		//Comandwindow
            ...
            if (!NATIVE_COMMANDS){
                request.setAttribute("error", "Exec of native commands is not allowed!");
            }
...
%></textarea>
	...
	<hr>
	<center>
		<small>jsp Browser version <%= VERSION_NR%></small>
	</center>
	</center>
</body>
</html>
...
<table class="formular">
	...
	<hr>
	<center>
		<small>jsp File version <%= VERSION_NR%></small>
	</center>
</body>
</html>
<%
